  ...
  <div id="sidebar">
    ...
    <ul class="nav">
      ...
      <li>
        <a href="login.php">
          <i class="zmdi zmdi-link">
          <button type="button" class="btn btn-danger"><b>Logout</b>
          </button>
          </i>
        </a>
      </li>
  ...
  <center>
	<table border="1">
      ...
      $no = 1;
        ...
        <td><?php echo $d['status']; ?></td>
				<td>
					<a href="edit.php?id=<?php echo $d['id_minuman']; ?>">
          <button type="button" class="btn btn-info">EDIT</button></a>
					<a href="hapus.php?id=<?php echo $d['id_minuman']; ?>">
          <button type="button" class="btn btn-danger">HAPUS</button></a>
				</td>
    </tr>
			<?php 
